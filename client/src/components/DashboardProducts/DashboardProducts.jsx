...
const DashboardProducts = ({ token, productsArray, categoriesArray,handleProductsUpdate }) => {
  ...
  const updateProductDetails = async (params, event, details) => {
    ...
    const updatedProduct = products.filter((product) => product._id === params.id)[0];
      ...
      {isLoading ? (
        ...
        <>
          <DataGrid
            ...
            sx={{ height: '100vh' }}
            onCellEditCommit={updateProductDetails}></DataGrid>
          ...
          {isEditDialogOpen && (
            <DashboardProductsDialog
              ...
              categories={categories}></DashboardProductsDialog>
          )}
          {isRemoveDialogOpen && (
            <DashboardProductsRemoveDialog
              ...
              product={currentProduct}></DashboardProductsRemoveDialog>
          )}
          {isRestoreDialogOpen && (
            <DashboardProductRestoreDialog
              ...
              product={currentProduct}></DashboardProductRestoreDialog>
          )}
          <Snackbar
