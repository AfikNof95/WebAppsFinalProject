      ...
      <List>
        <ListItem>
          <FormControl sx={{ m: 1, minWidth: 120 }}>
            ...
            >
              <MenuItem value={SORT_BY_ENUM.NAME_ASCENDING.value}>
                Name Ascending
              </MenuItem>
              <MenuItem value={SORT_BY_ENUM.NAME_DESCENDING.value}>
                Name Descending
              </MenuItem>
              <MenuItem value={SORT_BY_ENUM.PRICE_ASCENDING.value}>
                Price Low To High
              </MenuItem>
              <MenuItem value={SORT_BY_ENUM.PRICE_DESCENDING.value}>
                Price High To Low
              </MenuItem>
            </Select>
          </FormControl>
        ...
        <ListItem>
          <Slider
            ...
            onChangeCommitted={(event, value) => handlePriceRange(value)}
